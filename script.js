...
tl.to("#loader",{
    opacity:0,
    duration:0.2,
    delay:0 // later change this to 4
});
tl.from("#page1",{
    delay:0.2,
    y:1600,
...
tl.from("#page2",{
    opacity:0,
},"-=1.2"); // yime line mai tez ya dheere cjalane ke liye "-=value"

}
function mouscontrol(){
Shery.mouseFollower({
    shew:true,
